...
class PrepareAprPage extends StatefulWidget {
  const PrepareAprPage({super.key});

  @override
  State<PrepareAprPage> createState() => _PrepareAprPageState();
}

class _PrepareAprPageState extends State<PrepareAprPage>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Theme.of(context).scaffoldBackgroundColor,
      drawer: const FacultyNavigationDrawer(currentRoute: AppRoute.prepareApr),
      appBar: AppBar(
